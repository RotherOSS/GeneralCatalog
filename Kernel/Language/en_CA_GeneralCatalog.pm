...
sub Data {
    ...
    $Self->{Translation}->{'This is the namespace in which this field will be used as prefix with the name.'} =
        '';
    $Self->{Translation}->{'Tooltip message:'} = '';
    $Self->{Translation}->{'This is the tooltip message shown inside the customer interface.'} =
        '';
    $Self->{Translation}->{'Filter items by class.'} = '';
    $Self->{Translation}->{'Set the general catalog class.'} = '';
    $Self->{Translation}->{'Multiple Values'} = '';
    $Self->{Translation}->{'Activate this option to allow multiple values for this field.'} =
        '';
